...
Optional: Web Interface (Open WebUI):
If you prefer a web-based interface, you can install Ollama WebUI:
Install Snapd (if not already installed): sudo apt update && sudo apt install snapd
Install Ollama WebUI: sudo snap install ollama-webui --beta
